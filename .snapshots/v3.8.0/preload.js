...
contextBridge.exposeInMainWorld('rrBridge', {
  ...
  invScanQuick:       ()            => ipcRenderer.invoke('inv-scan-quick'),
  avproConfigLoad:    ()            => ipcRenderer.invoke('avpro-config-load'),
  avproConfigSave:    (data)        => ipcRenderer.invoke('avpro-config-save', data),
  avproRooms:         ()            => ipcRenderer.invoke('avpro-rooms'),
  avproCheckoff:      (payload)     => ipcRenderer.invoke('avpro-checkoff', payload),
